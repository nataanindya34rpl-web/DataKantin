{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyN55MHTQfjj1GdPWlk7wW/0",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/nataanindya34rpl-web/DataKantin/blob/main/dataset_Akademik_py.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "source": [
        ...
        "import numpy as np\n",
        "\n",
        "# 1. Baca data dari file CSV dengan nama file yang benar\n",
      ...
      "metadata": {
        ...
        "id": "dsJTd7BUQQYw",
        "outputId": "e0eb28f4-e8c5-4e8e-9626-dfa9a615b255"
      },
      "execution_count": 23,
      "outputs": [
        {
          ...
          "text": [
            ...
            "0    2026-08-06   46.0      Ibu Wati  \n",
            "1    2026-08-12   73.0  Bpk. Santoso  \n",
            "2    2026-08-15   69.0  Bpk. Santoso  \n",
            "3    2026-08-10   73.0   Bpk. Arifin  \n",
            "4    2026-08-06   53.0      Ibu Wati  \n"
          ]
        }
      ]
    }
